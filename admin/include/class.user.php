        ...
        class user
        {
            ...
            public function add_room($roomname, $room_qnty, $no_bed, $bedtype,$facility,$price)
            {
                  ...
                  $available=$room_qnty;
                   ...
                   /*$sql6="INSERT INTO room_category SET roomname='$roomname',room_qnty='$room_qnty', available='$room_qnty', booked='$booked', no_bed='$no_bed', bedtype='$bedtype', facility='$facility', price='$price'";
                   ...
                   $sql="INSERT INTO room_category  SET roomname='$roomname', available='$available', booked='$booked', room_qnty='$room_qnty', no_bed='$no_bed', bedtype='$bedtype', facility='$facility', price='$price'";
                    ...
                    for($i=0;$i<$room_qnty;$i++)
                    {
                       ...
                       $sql2="INSERT INTO rooms SET room_cat='$roomname', book='$val'";
...
*/
                $sql = "SELECT DISTINCT room_cat FROM rooms WHERE  book = 'false' ";
             ...
             public function booknow($checkin, $checkout, $name, $phone,$roomname)
            {
                 ...
                 /*   $sql="SELECT * FROM rooms WHERE room_cat='$roomname' AND 
                        (room_id NOT IN (SELECT DISTINCT room_id
   FROM rooms WHERE checkin <= '$checkin' AND checkout >='$checkout'))";*/
                    $sql="SELECT * FROM rooms WHERE room_cat='$roomname' AND book = 'false'"; 
             ...
             public function edit_all_room($checkin, $checkout, $name, $phone,$id)
            {
                        ...
                        if($send)
                        {
                            $result="Your Room has been updated successfully!!";
                        }
                        else
                        {
                            $result="Sorry, Internel Error";
            ...
            public function contacts($fullname, $email, $feedback)
            {
                $sql="INSERT INTO contacts  SET fullname='$fullname', email='$email', feedback='$feedback'";
                $result=mysqli_query($this->db,$sql) or die(mysqli_connect_errno()."Data cannot inserted");
                   return $result;
            ...
            public function delete_room($id) {
                        $sql2="DELETE FROM rooms WHERE room_id='$id'";
                        $result = mysqli_query($this->db,$sql2);
                        return $result;
