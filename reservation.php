...
<body>
    <div class="container">
       ...
       <div class='row'>
        ...
        <div class='col-md-5 well' style="height:200px">
            ...
            if(mysqli_num_rows($result) > 0)
            {
                ...
                while($row = mysqli_fetch_array($result))
                {
                   ...
                   echo "
                            ...
                            <div class='col-md-3'>
                                <a href='./booknow.php?roomname=".$row2['roomname']."'><button class='btn btn-primary button' style='margin-top:180px;'>Book Now</button></a>
                            </div>   
                            </div>
