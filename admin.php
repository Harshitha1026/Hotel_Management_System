           ...
           <div class="col-md-3"></div>
            <div class="col-md-6 well">
                ...
                <ul>
                    ...
                    <li><a href="room_cat.php">Show All Room Category</a></li>
           ...
           <div class="col-md-3"></div>
            <div class="col-md-6 well">
                ...
                <ul>
                    ...
                    <li><a href="show_room.php">Show All Booked Rooms</a></li>
                    <li><a href="show_all_room.php">Edit/Delete Booked Room</a></li>
                </ul>
            </div>
           <div class="col-md-3"></div>
        </div>
