...
<body>
    <div class="container">
      ...
      <div class="well">
          <h2><b>Book Now: <?php echo $roomname; ?></b></h2>
            <hr>
            <form action="" method="post" name="room_category">
                ...
                <div class="form-group" >
                    ...
                    <input type="date" class="datepicker" name="checkin" placeholder="YYYY-MM-DD">

                </div>
               
               <div class="form-group">
                    <label for="checkout">Check Out:</label>&nbsp;
                    <input type="date" class="datepicker" name="checkout" placeholder="YYYY-MM-DD">
                </div>
                <div class="form-group">
